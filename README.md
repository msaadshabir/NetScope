...
- **Zero-copy protocol parsing** -- Ethernet, Linux SLL, loopback NULL/LOOP, raw IP, 802.1Q VLAN, ARP, IPv4, IPv6, TCP, UDP, ICMP, ICMPv6, DNS (UDP/53 decode), TLS ClientHello SNI extraction (best-effort, packet-level)
